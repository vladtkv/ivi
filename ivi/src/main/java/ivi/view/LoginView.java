...
public class LoginView {
	...
	public void init() {
		frame = new Frame(Program.PROGRAM_CAPTION_STRING, new Dimension(350,
				425), 0, JFrame.EXIT_ON_CLOSE, null);
		...
		imagePanel.add(new ImageComponent("/img/google_logo.png",
			...
			public void actionPerformed(ActionEvent e) {
				if (!loginModel.login())
					JOptionPane
							.showMessageDialog(
									null,
									"There was an error while connecting to the YouTube service!",
